...
<body>
        ...
        <div class="container px-6 py-3 mx-auto md:flex">
            ...
            <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-cyan-950 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between">
                <div class="flex flex-col px-2 -mx-4 md:flex-row md:mx-10 md:py-0">
                    ...
                    <a href="/itemType" class="px-2.5 py-2 text-gray-700 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 md:mx-2 text-lg font-semibold">RETURN</a>
                  </div>
                </nav>
    ...
    <div class="bg-gray-800 h-screen">
        <div class="mx-auto w-[50%] pt-56">
                ...
                <form action="/save/{{$id}}" class=" flex flex-col" method="POST">
                    @method('POST')
                    @csrf    
                <input type="text" name="name" id="" cols="30" rows="10" class=" h-20 text-gray-700 bg-white border rounded-lg mb-4" placeholder="Type Name...">
